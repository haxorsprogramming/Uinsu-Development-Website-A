...
<head>
    ...
    <!-- Bootstrap  -->
    <link rel="stylesheet" type="text/css" href="<?=STYLEBASE; ?>/login/stylesheets/bootstrap.css" >

    <!-- Theme Style -->
    <link rel="stylesheet" type="text/css" href="<?=STYLEBASE; ?>/login/stylesheets/style.css">

    <!-- Responsive -->
    <link rel="stylesheet" type="text/css" href="<?=STYLEBASE; ?>/login/stylesheets/responsive.css">
    
    <!-- Colors -->
    <link rel="stylesheet" type="text/css" href="<?=STYLEBASE; ?>/login/stylesheets/colors/color1.css" id="colors">
    
    <!-- Animation Style -->
    <link rel="stylesheet" type="text/css" href="<?=STYLEBASE; ?>/login/stylesheets/animate.css">
    ...
    <div class="boxed">
                    ...
                    <div class="header-wrap clearfix">
                        ...
                        <div class="nav-wrap">
                            ...
                            <nav id="mainnav" class="mainnav">
                                <ul class="menu"> 
                                    <li class="home">
                                        <a href="index.html">Home <span class="menu-description">All Variations</span></a>
                                        <ul class="submenu">
                                            <li><a href="index.html">Homepage V1</a></li>
                                            <li><a href="index-v2.html">Homepage V2</a></li>
                                            <li><a href="index-v3.html">Homepage V3</a></li>
                                            <li><a href="index-v4.html">Homepage V4</a></li>
                                            <li><a href="index-v5.html">Homepage V5</a></li>
                                            <li><a href="index-v6.html">Homepage V6</a></li>
                                            <li><a href="index-v7.html">Homepage V7</a></li>
                                            <li><a href="index-v8.html">Homepage V8</a></li>
                                            <li><a href="index-v9.html">Homepage V9</a></li>
                                        </ul><!-- /.submenu -->
                                    </li>
                                    <li>
                                        <a href="event-list.html">Events <span class="menu-description">Our Activities</span></a>
                                        <ul class="submenu">
                                            <li><a href="event-list.html">Event List</a></li>
                                            <li><a href="event-grid.html">Event Grid</a></li>
                                            <li><a href="event-carousel.html">Event Carousel</a></li>
                                            <li><a href="event-single.html">Single Event V1</a></li>
                                        </ul><!-- /.submenu -->
                                    </li> 
                                    <li>
                                        <a href="course-list.html">Courses <span class="menu-description">Research &amp; Study</span></a>
                                        <ul class="submenu">
                                            <li><a href="course-list.html">Course List Classic</a></li>
                                            <li><a href="course-grid.html">Course Grid</a></li>
                                            <li><a href="course-list-table.html">Course List In Table</a></li>
                                            <li><a href="course-single.html">Single Course</a></li>
                                        </ul><!-- /.submenu -->
                                    </li>                                
                                    <li>
                                        <a href="">Pages <span class="menu-description">Designed Pages</span></a>
                                        <ul class="submenu submenu-right">
                                            <li><a href="blog.html">Blog</a></li>
                                            <li><a href="member.html">Members</a></li>
                                            <li><a href="member-single.html">Member Details</a></li>
                                    ...
                                    <li class="has-mega-menu"><a href="#">Shortcodes <span class="menu-description">Simple &amp; Useful</span></a>
                                        <ul class="submenu submenu-right mega-menu"> 
                                            <li class="menu-column">
                                                <ul>
                                                    <li><a href="#" class="menu-link  sub-menu-link">Elements</a></li>
                                                    <li><a href="#" class="menu-link  sub-menu-link">Elements</a></li>
                                                    <li><a href="#" class="menu-link  sub-menu-link">Elements</a></li>
                                                    <li><a href="#" class="menu-link  sub-menu-link">Elements</a></li>
                                                    <li><a href="#" class="menu-link  sub-menu-link">Elements</a></li>
                                                    ...
                                                    <div class="scroller-item-content post-item-mini">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 post-content-mini">
                                                                <h4><a class="post-title-mini main-color-1-hover" href="http://university.cactusthemes.com/video-post/" title="Your Career Starts Here">Your Career Starts Here</a></h4>
                                                ...
                                                <div class="scroller-item-inner">
                                                    <div class="scroller-item-content post-item-mini">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 post-content-mini">
                                                                <h4><a class="post-title-mini main-color-1-hover" href="http://university.cactusthemes.com/gallery-post/" title="Spark Of Genius">Spark Of Genius</a></h4>
                                                ...
                                                <div class="scroller-item-inner">
                                                    <div class="scroller-item-content post-item-mini">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 post-content-mini">
                                                                <h4><a class="post-title-mini main-color-1-hover" href="http://university.cactusthemes.com/the-highest-ranked-university/" title="University Ranking">University Ranking</a></h4>
                                                ...
                                                <div class="scroller-item-inner">
                                                    <div class="scroller-item-content post-item-mini">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 post-content-mini">
                                                                <h4><a class="post-title-mini main-color-1-hover" href="http://university.cactusthemes.com/standard-post-2/" title="Our New Campus">Our New Campus</a></h4>
                                                ...
                                                <div class="scroller-item-inner">
                                                    <div class="scroller-item-content post-item-mini">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 post-content-mini">
                                                                <h4><a class="post-title-mini main-color-1-hover" href="http://university.cactusthemes.com/education-organization-theme/" title="Education Organization Theme">Education Organization Theme</a></h4>
                                                                <div class="post-excerpt-mini">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum equal blame belongs.</div>
                                                            </div>
                                                        </div>
                                                    </div><!--/post-item-mini-->
                                                </div>
                                                ...
                                                <div class="scroller-item-inner">
                                                    <div class="scroller-item-content post-item-mini">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 post-content-mini">
                                                                <h4><a class="post-title-mini main-color-1-hover" href="http://university.cactusthemes.com/summer-is-coming/" title="Summer Is Coming">Summer Is Coming</a></h4>
                                                                <div class="post-excerpt-mini">Except to obtain some advantage from quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam.</div>
                                                            </div>
                                                        </div>
                                                    </div><!--/post-item-mini-->
                                                </div>
                                                ...
                                                <div class="scroller-item-inner">
                                                    <div class="scroller-item-content post-item-mini">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-8 post-content-mini">
                                                                <h4><a class="post-title-mini main-color-1-hover" href="http://university.cactusthemes.com/blog-post-3/" title="Visiting Our Campus">Visiting Our Campus</a></h4>
                                                                <div class="post-excerpt-mini">who loves or pursues or desires lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod.</div>
                                                            </div>
                                                        </div>
                                                    </div><!--/post-item-mini-->
                                                </div>
            ...
            <div class="flat-fluid"  style="background-color:#20bf6b;">
                <div class="container" >
                    <div class="row">
                        <div class="col-md-4">
                            <div class="post">
                                <h1 class="title">UNIVERISTY THEME</h1>
                        ...
                        <div class="col-md-4">
                            <div class="post">
                                <h1 class="title">TOP 10 RANKED</h1>
                                <p>Our education services ranked top 10 all over the world by most recognized organizations. We provide courses from finance, social studies, economics, enginereering to computer science and programing.</p>
                        ...
                        <div class="col-md-4">
                            <div class="post">
                                <h1 class="title">GLOBAL RECOGNIZE</h1>
                                <p>It is the fact that this theme is loved by more than 100o customers around the world. We believe that this is the best solution for your Education Business. Please view 9 demos version for full feature list.</p>
                                <a class="flat-button button-button_30 btn-default " href="#" data-delay="0">PURCHASE NOW <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div><!--/row--> 
        ...
        <div class="page-title parallax parallax1">
            <div class="container">
                <div class="flat-university">
                    <div class="post">
                        <h1 class="title">UNIVERSITY CAMPUSES AROUND THE WORLD</h1>
                    </div><!--/post -->
                    ...
                    <div class="button-university">
                        <a class="flat-button color-v1" href="#3" data-delay="0">VIEW COURSES <i class="fa fa-angle-right"></i></a>
                        <p>OR</p>
                                            ...
                                            <div class="cs-post-header">
                                                <div class="cs-category-links">
                                                    <a class="overlay-top" href="#">
                                                        ...
                                                        <span class="price yellow">From £19</span>
                                                    </a>
                                            ...
                                            <div class="cs-post-header">
                                                <div class="cs-category-links">
                                                    <a class="overlay-top" href="#">
                                                        ...
                                                        <span class="price yellow">£54</span>
                                                    </a>
                                            ...
                                            <div class="cs-post-header">
                                                <div class="cs-category-links">
                                                    <a class="overlay-top" href="#">
                                                        ...
                                                        <span class="price yellow">From £149</span>
                                                    </a>
        ...
        <div class="page-title parallax parallax2">
            <div class="container">
                <div class="flat-university">
                    <div class="post">
                        <h1 class="title">FOR THOSE WHO NEVER STAND STILL. DON’T SAY NEXT YEAR, SAY NOW!</h1>
                    </div><!--/post -->

                    <div class="button-university">
                        <a class="flat-button color-v2" href="#3" data-delay="0">BUY THIS THEME</a>
                    </div><!--/button-university -->
                </div><!--/flat-university -->
            </div><!--/container -->        
        </div><!--/page-title -->
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="flat-accordion">
                                ...
                                <div class="flat-toggle">
                                    <div class="toggle-title active">Build Your Own Homepage With Visual Composer</div>
                                    <div class="toggle-content">
                                        <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>                                
                                    </div>
                                </div><!-- /toggle -->
                                <div class="flat-toggle">
                                    <div class="toggle-title">Clean, Beautiful And Responsive Design</div>
                                    <div class="toggle-content">
                                        <div class="info">                                    
                                ...
                                <div class="flat-toggle">
                                    <div class="toggle-title">U-Event Plugin Allow You To Sell Ticket</div>
                                    <div class="toggle-content">
                                        <div class="info">                                    
                                            <p class="desc-info">Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur.</p>
                                        </div>
                                    </div>
                                </div><!-- /.toggle -->
                                <div class="flat-toggle">
                                    <div class="toggle-title">Sell Courses With U-Course Plugin</div>
                                    <div class="toggle-content">
                                        <div class="info">                                    
                                            <p class="desc-info">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio.</p>
                                        </div>
                                    </div>
                                </div><!-- /.toggle -->

                                <div class="flat-toggle">
                                    <div class="toggle-title">Shop Version Available With Woo Commerce Integrated</div>
                                    <div class="toggle-content">
                                        <div class="info">                                    
                                            <p class="desc-info">Empty section. Edit page to add content here.</p>
                                        </div>
                                    </div>
                                </div><!-- /.toggle -->

                                <div class="flat-toggle">
                                    <div class="toggle-title">Professional Look and Feel For Your Business</div>
                                    <div class="toggle-content">
                                        <div class="info">                                    
                                            <p class="desc-info">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus</p>
                                        </div>
                                    </div>
                                </div><!-- /.toggle -->
                            </div><!-- /.accordion -->
        ...
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/owl.carousel.js"></script>
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/parallax.js"></script>
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/jquery-waypoints.js"></script>
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/jquery.tweet.min.js"></script>
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/jquery.matchHeight-min.js"></script>
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/jquery-validate.js"></script>
        
        

        <!-- Revolution Slider -->
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/jquery.themepunch.revolution.min.js"></script>
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/slider.js"></script>
        
        
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/jquery.cookie.js"></script> 
        <script type="text/javascript" src="<?=STYLEBASE; ?>/login/javascript/main.js"></script>
